    ...
    layout = html.Div([
        dbc.Alert([
            ...
            html.P("Por favor, haz tu selección en algunos filtros para obtener información particular de los registros históricos. "
                ...
                color="info"),
        html.P("Exportaciones según el país de destino", style={"font-weight": "600", "font-size": "16px", "margin-top": "24px"}),
        html.P("Según el valor total de las exportaciones en USD.",
