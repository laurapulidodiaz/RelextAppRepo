...
def data_cundinamarca_top10_export() :
    ...
    if type(df_exports_cundinamarca) == int :
        ...
        df_exports_cundinamarca['Descripción Arancelaria'] = df_exports['Descripción Arancelaria'].astype(str).loc[:,]
        df_exports_cundinamarca['Descripción Arancelaria Corta'] = df_exports['Descripción Arancelaria'].apply(lambda x : x[:100]).loc[:,]
