...
def data_cundinamarca_top10_export() :
    ...
    if type(df_exports_cundinamarca) == int :
        ...
        df_exports_cundinamarca.loc[:, 'Descripción Arancelaria'] = df_exports_cundinamarca['Descripción Arancelaria'].astype(str)
        df_exports_cundinamarca.loc[:, 'Descripción Arancelaria Corta'] = df_exports_cundinamarca['Descripción Arancelaria'].apply(lambda x : x[:100])
